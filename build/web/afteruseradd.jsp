...
<div class="wrapper">
  ...
  <div id="topbar">
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="">Policies Modification</a>
        <ul>
        ...
        <li><a href="#">Search</a>
        <ul>
            <li><a href="policysearch.jsp">Policy Wise</a></li>
            <li><a href="customersearch.jsp">Customer Wise</a></li>
            <li><a href="datesearch.jsp">Date wise</a></li>  
          </ul>
  ...
  <div id="intro">
    ...
    <div class="fl_right">
     <br><br>
                <p><font color="red"><h3 align="center"><marquee>NEW USER ADDED SUCCESSFULLY...!!!</h3></font></p></marquee>
    </div>
    <br class="clear" />
  </div>
  <!-- ####################################################################################################### -->
